    ...
    <div className="w-screen min-h-screen py-10 px-5">
      ...
      <div>
        <form className="flex flex-col gap-3 w-full ">
          <div className="w-full h-[400px] flex justify-between gap-20">
            <div className="w-1/2 h-full  flex flex-col justify-between">
              ...
              <div className="text-white  flex flex-col gap-1">
                ...
                />
                {errors.date && (
                  <p style={{ color: "orangered" }}>{errors.date.message}</p>
                )}
              </div>
              <div className="text-white  flex flex-col gap-1">
                ...
                />
                {errors.typeOfEvent && (
                  <p style={{ color: "orangered" }}>{errors.typeOfEvent.message}</p>
                )}
              </div>
            </div>
            <div className="w-1/2 h-full justify-between pr-3 flex flex-col gap-6">
              <div className="text-white  flex flex-col gap-1">
                ...
                {errors.shortDescription && (
                  <p style={{ color: "orangered" }}>{errors.shortDescription.message}</p>
                )}
              </div>
          ...
          <div className="w-full h-[60px] pr-3 mt-6">
            <button
              className={` w-full h-full bg-gradient-to-r from-blue-400 to-[#0c1feb] rounded-lg text-white text-2xl ${rowdies1.className} `}
            >
              Create Event
            </button>
          </div>
