  ...
  return (
    <div className="w-screen min-h-screen">
      ...
      <div className="w-full px-6 grid grid-cols-3 place-items-center py-20">
        <div className="w-[467px] h-[367px] bg-[#111111] rounded-md border-[1px] border-[#222] flex flex-col items-start justify-between px-4 py-5">
          ...
          <div className="text-[#D1D5DB] text-[14px]">
            <p>
              Looking for team members skilled in full-stack development and
              UI/UX design for a 24-hour hackathon focused on AI/ML solutions.
            </p>
          </div>
